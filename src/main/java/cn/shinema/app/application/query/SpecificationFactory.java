...
public class SpecificationFactory {
	 ...
	 * @return 查询条件的封装对象
	 */
	public static <T extends Comparable<T>> Specification<?> between(String fieldName, T min, T max) {
	 ...
	 * @return 查询条件的封装对象
	 */
	public static <T extends Comparable<T>> Specification<?> gte(String fieldName, T value) {
	 ...
	 * @return 查询条件的封装对象
	 */
	public static <T extends Comparable<T>> Specification<?> lte(String fieldName, T value) {
